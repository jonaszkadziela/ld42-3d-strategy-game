...
public class CameraController : MonoBehaviour
{
	...
	void Update()
	{
		...
		if (!moveToTarget)
		{
			...
			{
				position.z += GameSettings.PanSpeed * Time.deltaTime;
			}
			...
			{
				position.x -= GameSettings.PanSpeed * Time.deltaTime;
			}
			...
			position.y -= scroll * GameSettings.ScrollSpeed * 100f * Time.deltaTime;
